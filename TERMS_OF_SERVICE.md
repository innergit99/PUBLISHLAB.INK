# Terms of Service - Artisan AI

**Last Updated: January 18, 2026**

## 1. Agreement to Terms

By accessing Artisan AI ("Service"), you agree to be bound by these Terms of Service ("Terms"). If you disagree with any part of these terms, you may not access the Service.

## 2. Description of Service

Artisan AI provides AI-powered creative tools including:
- Book writing and publishing tools
...
- Billed monthly, auto-renewal unless cancelled
...
- You own content generated using our Service
- Subject to our Acceptable Use Policy
- We are not liable for AI-generated content accuracy

### 6.3 Our Service
- The Service, including software and branding, is our property
- Protected by copyright, trademark, and other laws

## 7. Payment Terms

### 7.1 Billing
- Subscriptions billed monthly via Paddle
- Prices in USD
...
- Request refund via email within 14 days
...
- We use secure payment processor (Paddle)

## 12. Third-Party Services

### 12.1 HuggingFace
- AI models hosted on HuggingFace infrastructure
- Subject to HuggingFace terms and policies
...
### 13.1 Governing Law
- These Terms governed by UAE law
- Disputes resolved in UAE courts

### 13.2 Arbitration
- Disputes may be submitted to binding arbitration
- Each party pays own legal fees

## 14. Changes to Terms

- We may update Terms anytime
- Notice via email or Service notification
...
- Unenforceable provisions reformed to be enforceable
...
By using Artisan AI, you agree to:
- Use the Service responsibly and legally
- Pay subscription fees on time
- Own content you create
- Accept our refund and cancellation policies
- Understand AI content may need review

**For full details, read complete Terms above.**
